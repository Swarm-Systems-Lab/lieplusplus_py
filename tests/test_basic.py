...
class TestSO3:
    ...
    def test_random_rotation(self):
        ...
        np.testing.assert_allclose(
            matrix @ matrix.T, np.eye(3), rtol=1e-10, atol=1e-10
        )
    ...
    def test_exp_log_consistency(self):
        ...
        np.testing.assert_allclose(
            R.asMatrix(), R_recovered.asMatrix(), rtol=1e-10, atol=1e-10
        )
    ...
    def test_jacobian_consistency(self):
        ...
        np.testing.assert_allclose(
            R_Jr @ R_Jr_inv, np.eye(3), rtol=1e-10, atol=1e-10
        )
    ...
    def test_group_operations(self):
        ...
        np.testing.assert_allclose(
            R12.asMatrix(), expected, rtol=1e-10, atol=1e-10
        )
        ...
        identity = R1 * R_inv
        np.testing.assert_allclose(
            identity.asMatrix(), np.eye(3), rtol=1e-10, atol=1e-10
        )
...
class TestSE3:
    ...
    def test_exp_log_consistency(self):
        ...
        np.testing.assert_allclose(
            T.asMatrix(), T_recovered.asMatrix(), rtol=1e-10, atol=1e-10
        )
    ...
    def test_group_operations(self):
        ...
        np.testing.assert_allclose(
            T12.asMatrix(), expected, rtol=1e-10, atol=1e-10
        )
        ...
        identity = T1 * T_inv
        np.testing.assert_allclose(
            identity.asMatrix(), np.eye(4), rtol=1e-10, atol=1e-10
        )
...
class TestSE23:
    ...
    def test_group_operations(self):
        ...
        np.testing.assert_allclose(
            X12.asMatrix(), expected, rtol=1e-10, atol=1e-10
        )
        ...
        identity = X1 * X_inv
        np.testing.assert_allclose(
            identity.asMatrix(), np.eye(5), rtol=1e-10, atol=1e-10
        )
