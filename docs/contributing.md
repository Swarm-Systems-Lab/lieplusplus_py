...
We welcome contributions to lieplusplus_py! This guide outlines how to contribute effectively following the **SSL Golden Path** standards.

## Before You Start

lieplusplus_py follows the Swarm Systems Lab (SSL) Golden Path, which means:
...
git clone https://github.com/YOUR_USERNAME/lieplusplus_py
cd lieplusplus_py

# Add upstream remote
git remote add upstream https://gitea.lyapunov.local/Swarm-Systems-Lab/lieplusplus_py
...
import pytest
from lieplusplus import my_function
...
- 💬 [GitHub Discussions](https://gitea.lyapunov.local/Swarm-Systems-Lab/lieplusplus_py/discussions)
- 🐛 [Issue Tracker](https://gitea.lyapunov.local/Swarm-Systems-Lab/lieplusplus_py/issues)
...
By contributing to lieplusplus_py, you agree that your contributions will be licensed under the **MIT** license.

---

**Thank you for contributing!** 🎉 Your efforts help make lieplusplus_py better for everyone.
